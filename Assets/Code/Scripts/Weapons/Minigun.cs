    ...
    public class Minigun : Weapon
    {
        ...
        public override void Attack(Vector3 firePosition, Vector3 fireDirection, bool justPressed, bool wasReleased)
        {
            ...
            if (justPressed)
            {
                ...
                chargeTimer = TickTimer.CreateFromSeconds(Runner, ChargeSound.clip.length);
                return;
            }
            ...
            if (IsCharging && !chargeTimer.Expired(Runner)) return;
        ...
        private void FireProjectile(Vector3 firePosition, Vector3 fireDirection)
        {
            ...
            Debug.DrawRay(firePosition, fireDirection * 100f, Color.red, 1.0f);
